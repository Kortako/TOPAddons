        ...
        if (entity instanceof EntityMinecartModular) {
            ...
            for (ModuleTank tank : tanks) {
                if (tank.getFluid() != null) {
                    AddonForge.addTankElement(probeInfo, tank.getData().getName(), tank.getInfo(), mode, getElementId(player, "tank_gauge"));
                } else {
                    AddonForge.addTankElement(probeInfo, tank.getData().getName(), "", 0, 0, "mB", 0, mode, getElementId(player, "tank_gauge"));
                }
            }
